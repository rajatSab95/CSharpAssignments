...
namespace EmployeeApi.Controllers
{
    ...
    {
        private static List<Employee> employees = new List<Employee>(){new Employee(){Id=1 ,FirstName="Arvind", LastName="Kejriwal", Department=1, Gender="Male", Country="Country.UK", Salary=12351, Dob=new DateTime(1999,05,01)},
                                                                    ...
                                                                    new Employee(){Id=79 ,FirstName="Prajakta", LastName="Bhosale",  Department=74, Gender="FeMale", Gender="Male", Country="Country.France", Salary=34685, Dob=new DateTime(2019,05,05)},
